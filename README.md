...
The objective of the analysis is to analyze public Citi Bike data from NYC in order to put together a presentation to investors to potentially build a similar bussines in Des Moines. The analysis is intended to address the following quetions
